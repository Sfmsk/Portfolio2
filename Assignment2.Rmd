...
#Drawing the plot
Data = data.frame(grid = p_grid, posterior = posterior, prior = prior1, likelihood = likelihood)

ggplot(Data, aes(grid, posterior)) + geom_point() + geom_line() + theme_classic() + geom_line(aes(grid, prior1/dens), color = 'red') + xlab("probability of correct answer") + ylab("posterior probability")
...
Defining a larger grid and defining priors
```{r}
